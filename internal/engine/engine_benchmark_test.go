...
func BenchmarkLSMEngineRandomMixedOps(b *testing.B) {
	...
	totalOps := float64(b.N * runsPerIter)
	b.ReportMetric(float64(b.Elapsed().Nanoseconds())/totalOps, "ns/op(avg10)")
}
